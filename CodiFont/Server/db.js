// Importem la llibreria sqlite3 en mode "verbose": això fa que els errors
// mostrin més informació al terminal, útil per debugar.
const sqlite3 = require("sqlite3").verbose();

// Obrim (o creem si no existeix) el fitxer de base de dades "game_data.db"
// a la mateixa carpeta on s'executa el servidor.
...
// db.serialize() garanteix que tot el que hi ha dins s'executa en ordre,
// una instrucció darrere l'altra. Sense això, Node (que és asíncron) podria
...
db.serialize(() => {
    ...
    // funcioni tant amb una DB nova com amb una antiga que no tingui
...
// Setter de la versió: s'usa des d'admin.js quan el dashboard fa un canvi
// important (com forçar refresc global o canviar l'esdeveniment actiu).
function setDataVersion(v) { globalDataVersion = v; }

// Exportem la connexió a la DB i les dues funcions perquè
// els altres mòduls puguin usar-les amb require('./db').
