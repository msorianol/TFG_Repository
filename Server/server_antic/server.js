...
app.post('/add-items', (req, res) => {
    ...
    // Dates (només per a items de temporada)
    if (isFixed) {
        entry.fixed = true;
    } else {
        entry.type = b.type;
    ...
    // Condicions de jugador — usem Object.keys per robustesa
    // (el while amb índex podia fallar si els camps arriben fora d'ordre)
